      ...
      <div className="max-w-4xl mx-auto text-left">
        <div className="mb-8">
          ...
          <p className="text-center font-semibold mt-2">
            Last updated <strong>June 22, 2025</strong>
          </p>
        </div>

        <section className="mb-8">
          <h2 id="agreement" className="text-2xl font-bold mb-4">
            AGREEMENT TO OUR LEGAL TERMS
          </h2>
          <p className="mb-4 leading-relaxed">
            We are <strong>UpVachi</strong> ("<strong>Company</strong>," "
            <strong>we</strong>," "<strong>us</strong>," "<strong>our</strong>
            "), a company registered in <strong>India</strong> at{" "}
            <strong>
              House No. 8, Aashriya Colony, Phase 2, Sri Ram Nagar, Huzir,
          ...
          <p className="mb-4 leading-relaxed">
            ...
            legal terms (the "<strong>Legal Terms</strong>") (collectively, the
            "<strong>Services</strong>").
          </p>
          <p className="mb-4 leading-relaxed">
            UpVachi is an AI-powered chat automation platform for individuals,
            creators, and businesses. Users can connect their social accounts
            (such as WhatsApp, Facebook, and Instagram) to automate messaging,
            manage conversations, engage audiences, and personalize responses
            using advanced artificial intelligence. UpVachi offers tools for
            conversation management, analytics, and integrations with popular
            messaging platforms.
          </p>
          <p className="mb-4 leading-relaxed">
            You can contact us by phone at <strong>+91 9508699629</strong>,
            email at <strong>upvachi@gmail.com</strong>, or by mail to{" "}
            <strong>
              House No. 8, Aashriya Colony, Phase 2, Sri Ram Nagar, Huzir,
          ...
          <p className="mb-4 leading-relaxed">
            ...
            <strong>you</strong>"), and <strong>UpVachi</strong>, concerning
            your access to and use of the Services. You agree that by accessing
            the Services, you have read, understood, and agreed to be bound by
          ...
          <p className="mb-4 leading-relaxed">
            ...
            <strong>upvachi@gmail.com</strong>, as stated in the email message.
        ...
        <section className="my-10 p-6 border rounded-lg bg-gray-50">
          <h2 className="text-2xl font-bold mb-4">TABLE OF CONTENTS</h2>
          <ol className="list-decimal list-inside space-y-2 text-blue-600">
            <li>
              <InternalLink href="#services" className="hover:underline">
                1. OUR SERVICES
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#ip" className="hover:underline">
                2. INTELLECTUAL PROPERTY RIGHTS
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#userreps" className="hover:underline">
                3. USER REPRESENTATIONS
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#userreg" className="hover:underline">
                4. USER REGISTRATION
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#purchases" className="hover:underline">
                5. PURCHASES AND PAYMENT
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#subscriptions" className="hover:underline">
                6. SUBSCRIPTIONS
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#prohibited" className="hover:underline">
                7. PROHIBITED ACTIVITIES
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#ugc" className="hover:underline">
                8. USER GENERATED CONTRIBUTIONS
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#license" className="hover:underline">
                9. CONTRIBUTION LICENSE
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#reviews" className="hover:underline">
                10. GUIDELINES FOR REVIEWS
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#mobile" className="hover:underline">
                11. MOBILE APPLICATION LICENSE
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#socialmedia" className="hover:underline">
                12. SOCIAL MEDIA
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#thirdparty" className="hover:underline">
                13. THIRD-PARTY WEBSITES AND CONTENT
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#sitemanage" className="hover:underline">
                14. SERVICES MANAGEMENT
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#ppyes" className="hover:underline">
                15. PRIVACY POLICY
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#copyrightyes" className="hover:underline">
                16. COPYRIGHT INFRINGEMENTS
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#terms" className="hover:underline">
                17. TERM AND TERMINATION
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#modifications" className="hover:underline">
                18. MODIFICATIONS AND INTERRUPTIONS
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#law" className="hover:underline">
                19. GOVERNING LAW
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#disputes" className="hover:underline">
                20. DISPUTE RESOLUTION
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#corrections" className="hover:underline">
                21. CORRECTIONS
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#disclaimer" className="hover:underline">
                22. DISCLAIMER
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#liability" className="hover:underline">
                23. LIMITATIONS OF LIABILITY
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#indemnification" className="hover:underline">
                24. INDEMNIFICATION
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#userdata" className="hover:underline">
                25. USER DATA
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#electronic" className="hover:underline">
                26. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#california" className="hover:underline">
                27. CALIFORNIA USERS AND RESIDENTS
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#misc" className="hover:underline">
                28. MISCELLANEOUS
              </InternalLink>
            </li>
            <li>
              <InternalLink href="#contact" className="hover:underline">
                29. CONTACT US
              </InternalLink>
            </li>
          </ol>
        ...
        <section id="ip" className="mb-8">
          ...
          <h3 className="text-xl font-bold my-4">Your use of our Services</h3>
          <p className="mb-4 leading-relaxed">
          ...
          <p className="mb-4 leading-relaxed">
            ...
            please address your request to: <strong>upvachi@gmail.com</strong>.
          ...
          <h3 className="text-xl font-bold my-4">Copyright infringement</h3>
          <p className="leading-relaxed">
        ...
        <section id="userreg" className="mb-8">
          <h2 className="text-2xl font-bold mt-8 mb-4">4. USER REGISTRATION</h2>
          <p className="leading-relaxed">
        ...
        <section id="purchases" className="mb-8">
          ...
          <ul className="list-disc pl-10 mb-4 leading-relaxed">
            <li>PayPal</li>
            <li>Razorpay</li>
          </ul>
          <p className="mb-4 leading-relaxed">
        ...
        <section id="subscriptions" className="mb-8">
          <h2 className="text-2xl font-bold mt-8 mb-4">6. SUBSCRIPTIONS</h2>
          <h3 className="text-xl font-bold mb-3">Billing and Renewal</h3>
          <p className="mb-4 leading-relaxed">
            Subscriptions will not be renewed automatically. We will contact you
            by email prior to expiry to ask if you wish to renew your
            subscription and communicate the cost of renewing your subscription.
          </p>

          <h3 className="text-xl font-bold my-4">Free Trial</h3>
          <p className="mb-4 leading-relaxed">
            We offer a <strong>__________</strong>-day free trial to new users
            who register with the Services. The account will not be charged and
            the subscription will be suspended until upgraded to a paid version
            at the end of the free trial.
          </p>

          <h3 className="text-xl font-bold my-4">Cancellation</h3>
          <p className="mb-4 leading-relaxed">
            ...
            <strong>upvachi@gmail.com</strong>.
          </p>

          <h3 className="text-xl font-bold my-4">Fee Changes</h3>
          <p className="leading-relaxed">
        ...
        <section id="mobile" className="mb-8">
          ...
          <h3 className="text-xl font-bold my-4">Apple and Android Devices</h3>
          <p className="leading-relaxed">
        ...
        <section id="socialmedia" className="mb-8">
          <h2 className="text-2xl font-bold mt-8 mb-4">12. SOCIAL MEDIA</h2>
          <p className="leading-relaxed">
        ...
        <section id="ppyes" className="mb-8">
          <h2 className="text-2xl font-bold mt-8 mb-4">15. PRIVACY POLICY</h2>
          <p className="leading-relaxed">
            ...
            advised the Services are hosted in <strong>India</strong>. If you
            ...
            <strong>India</strong>, then through your continued use of the
            Services, you are transferring your data to <strong>India</strong>,
            and you expressly consent to have your data transferred to and
            processed in <strong>India</strong>.
          </p>
        </section>

        <section id="copyrightyes" className="mb-8">
          <h2 className="text-2xl font-bold mt-8 mb-4">
            16. COPYRIGHT INFRINGEMENTS
          </h2>
          <p className="leading-relaxed">
        ...
        <section id="law" className="mb-8">
          <h2 className="text-2xl font-bold mt-8 mb-4">19. GOVERNING LAW</h2>
          <p className="leading-relaxed">
            These Legal Terms shall be governed by and defined following the
            laws of <strong>India</strong>. <strong>UpVachi</strong> and
            yourself irrevocably consent that the courts of{" "}
            <strong>India</strong> shall have exclusive jurisdiction to resolve
        ...
        <section id="disputes" className="mb-8">
          ...
          <h3 className="text-xl font-bold my-4">Binding Arbitration</h3>
          <p className="mb-4 leading-relaxed">
            ...
            arbitrators shall be <strong>one (1)</strong>. The seat, or legal
            place, or arbitration shall be <strong>Ranchi, India</strong>. The
            language of the proceedings shall be <strong>English</strong>. The
            governing law of these Legal Terms shall be substantive law of{" "}
            <strong>India</strong>.
          </p>
          <h3 className="text-xl font-bold my-4">Restrictions</h3>
          <p className="mb-4 leading-relaxed">
        ...
        <section id="corrections" className="mb-8">
          <h2 className="text-2xl font-bold mt-8 mb-4">21. CORRECTIONS</h2>
          <p className="leading-relaxed">
        ...
        <section id="disclaimer" className="mb-8">
          <h2 className="text-2xl font-bold mt-8 mb-4">22. DISCLAIMER</h2>
          <p className="leading-relaxed">
        ...
        <section id="liability" className="mb-8">
          ...
          <p className="leading-relaxed">
            ...
            US DURING THE <strong>six (6)</strong> MONTH PERIOD PRIOR TO ANY
            CAUSE OF ACTION ARISING OR <strong>$100.00 USD</strong>. CERTAIN US
        ...
        <section id="indemnification" className="mb-8">
          <h2 className="text-2xl font-bold mt-8 mb-4">24. INDEMNIFICATION</h2>
          <p className="leading-relaxed">
        ...
        <section id="userdata" className="mb-8">
          <h2 className="text-2xl font-bold mt-8 mb-4">25. USER DATA</h2>
          <p className="leading-relaxed">
        ...
        <section id="misc" className="mb-8">
          <h2 className="text-2xl font-bold mt-8 mb-4">28. MISCELLANEOUS</h2>
          <p className="leading-relaxed">
        ...
        <section id="contact" className="mb-8">
          <h2 className="text-2xl font-bold mt-8 mb-4">29. CONTACT US</h2>
          <p className="mb-4 leading-relaxed">
          ...
          <div className="leading-relaxed font-semibold">
            ...
            <p>India</p>
            <p className="mt-4">Phone: +91 9508699629</p>
            <p>upvachi@gmail.com</p>
          </div>
        </section>
      </div>
    </div>
