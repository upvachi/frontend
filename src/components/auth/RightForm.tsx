...
const RightForm = ({
  ...
  return (
    <div className="w-full h-full lg:bg-gradient-to-br from-zinc-950 via-black to-zinc-900 p-10 lg:p-14 flex flex-col justify-center backdrop-blur-sm lg:border-l md:border-zinc-800/30 relative z-10 rounded-r-4xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 font-sans">
          {!isLogin && (
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3.5 bg-zinc-950/60 border rounded-xl text-white text-sm placeholder-zinc-500 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-white/20 focus:border-white/30 backdrop-blur-sm ${
                  errors.fullName
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={handleInputChange}
                className={`w-full px-4 py-3.5 pr-12 bg-zinc-950/60 border rounded-xl text-white text-sm placeholder-zinc-500 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-white/20 focus:border-white/30 backdrop-blur-sm ${
                  errors.password
                    ? "border-red-500/50 bg-red-950/20"
                    : "border-zinc-700/50 hover:border-zinc-600/50"
                }`}
          ...
          <div className="flex items-center justify-center mt-8">
            <button
              type="submit"
              disabled={isLoading}
              className={`transition-all duration-300 flex items-center justify-center font-semibold shadow-lg disabled:opacity-70 disabled:cursor-not-allowed text-zinc-950 ${
                isLoading
